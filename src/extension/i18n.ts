...
const MESSAGES: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    'options.groupingStrategy': 'グルーピング戦略',
    'options.groupingStrategy.inheritFirst': 'inherit first',
    'options.groupingStrategy.ruleFirst': 'rule first',
    'options.groupingStrategy.ruleOnly': 'rule only',
    'options.groups': 'グループ',
    'options.addGroup': 'グループ追加',
    'options.emptyGroups': 'グループがまだありません。「＋ グループ追加」から始めましょう。',
    'options.groupTitle': 'グループ {index}',
    'options.group.name': 'グループ名',
    'options.group.namePlaceholder': 'Work',
    'options.group.color': 'カラー',
    'options.group.ttlMinutes': 'TTL(分)',
    'options.group.maxTabs': '最大タブ数',
    'options.group.lru': 'LRU',
    'options.group.remove': 'グループ削除',
    'options.group.rules': 'ルール',
    'options.group.addRule': 'ルール追加',
    'options.rule.pattern': 'パターン',
    'options.rule.matchMode': 'マッチ方式',
    'options.rule.actions': '操作',
    'options.rule.remove': 'ルール削除',
  ...
  en: {
    ...
    'options.applyMode.newTabs': 'only new tab',
    'options.applyMode.manual': 'none',
    'options.groupingStrategy': 'Grouping strategy',
    'options.groupingStrategy.inheritFirst': 'inherit first',
    'options.groupingStrategy.ruleFirst': 'rule first',
    'options.groupingStrategy.ruleOnly': 'rule only',
    'options.groups': 'Groups',
    'options.addGroup': 'Add group',
    'options.emptyGroups': 'No groups yet. Click \"+ Add group\" to get started.',
    'options.groupTitle': 'Group {index}',
    'options.group.name': 'Group name',
    'options.group.namePlaceholder': 'Work',
    'options.group.color': 'Color',
    'options.group.ttlMinutes': 'TTL (min)',
    'options.group.maxTabs': 'Max tabs',
    'options.group.lru': 'LRU',
    'options.group.remove': 'Remove group',
    'options.group.rules': 'Rules',
    'options.group.addRule': 'Add rule',
    'options.rule.pattern': 'Pattern',
    'options.rule.matchMode': 'Match mode',
    'options.rule.actions': 'Actions',
    'options.rule.remove': 'Remove rule',
